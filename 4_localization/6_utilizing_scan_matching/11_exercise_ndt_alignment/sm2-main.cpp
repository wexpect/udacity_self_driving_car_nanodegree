...
/*
step 1, press i to run ICP, or n to run ndt
...
step 4, press i to run ICP, or n to run ndt
*/
...
Eigen::Matrix4d NDT(pcl::NormalDistributionsTransform<pcl::PointXYZ, pcl::PointXYZ> ndt, PointCloudT::Ptr source, Pose startingPose, int iterations){
	...
	// NOTE: different from ICP
	// ICP use transformed_source
	// NDT use source, and pass in init_guess in ndt.align()
...
int main(){
	...
	ndt.setResolution(3);  // NOTE: original value is 1, not work well
