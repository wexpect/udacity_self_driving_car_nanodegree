...
#     img_range = img_range[:,ri_center-deg45:ri_center+deg45]  
    ...
    val_1th = np.percentile(ri_intensity, 1)
    val_99th = np.percentile(ri_intensity, 99)
    ri_intensity[ ri_intensity < val_1th ] = val_1th
    ri_intensity[ ri_intensity > val_99th ] = val_99th

    ri_intensity = ri_intensity / ( val_99th - val_1th ) * 255
...
#     print('lidar_pcl', lidar_pcl)    
    """    
    lidar_pcl 
    [[ 5.79995043e-01  1.18032757e+01  3.70521196e+00  1.20849609e-02]
     [ 6.02714277e-01  1.18811168e+01  3.70865187e+00  1.16577148e-02]
     [ 6.34432773e-01  1.18305134e+01  3.70642265e+00  3.63769531e-02]
     ...
     [ 1.25405135e-01 -3.09870002e+00  2.10587731e+00  1.09863281e-02]
     [ 7.45386334e-02 -3.19826213e+00  2.07010366e+00  1.67236328e-02]
     [ 1.88165308e-02 -3.30785621e+00  2.03075316e+00  2.55126953e-02]]
    """    
...
#     print('lidar_pcl_cpy', lidar_pcl_cpy)    
    ...
    xy_vals, indices, counts = np.unique(lidar_pcl_cpy[:, 0:2], axis=0, return_index=True, return_counts=True)    
    # print('xy_vals, indices, counts', xy_vals, indices, counts)
...
# #     cv2.putText(img_intensity,"222", (100,200), cv2.FONT_HERSHEY_SIMPLEX, 1, 255)    
#     cv2.imshow('img_intensity', img_intensity)        
#     cv2.waitKey(0)    
# #     cv2.imwrite('img_intensity.jpg',img_intensity)
    ...
    xy_vals, idx_height_unique = np.unique(lidar_pcl_hei[:, 0:2], axis=0, return_index=True)
...
#     cv2.waitKey(0)    
#     cv2.imwrite('img_height.jpg',img_height)
...
#     intensity_map = []
    ...
    # NOTE: Udacity use log(64) here. Seems using 64 is too large
...
#     cv2.waitKey(0)    
#     cv2.imwrite('img_density.jpg',img_density)     
...
#     img_bev = (bev_map * 255).astype(np.uint8)
#     cv2.imshow('img_bev', img_bev)
#     cv2.waitKey(0)    
#     cv2.imwrite('img_bev.jpg',img_bev)     
